...
from ....PyInstaller import utils as ___vendorize__0
PyInstaller.utils = ___vendorize__0
from ....PyInstaller.utils import misc as ___vendorize__1
PyInstaller.utils.misc = ___vendorize__1
