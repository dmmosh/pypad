...
from ....PyInstaller import depend as ___vendorize__0
PyInstaller.depend = ___vendorize__0
from ....PyInstaller.depend import bindepend as ___vendorize__1
PyInstaller.depend.bindepend = ___vendorize__1
from .... import PyInstaller
