...
if gl.var['auto_cursor'] == True:
    gl.r.update()
    gl.mouse_c.move(-gl.r.winfo_screenwidth(),-gl.r.winfo_screenheight()) # moves the mouse to the TOP LEFT of the screen
    gl.mouse_c.move(term.winfo_rootx(), term.winfo_rooty()) # moves the mouse
