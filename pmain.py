...
# yes or no prompt
def yes_or_no(message:str = "Yes or no?", width:int = 300, height:int = 200) -> int:
    ...
    ok = make_btn(options, text='okie dokie ✓', command=lambda: set(0))
    cancel = make_btn(options, text='cancel X', command=lambda: set(1))
